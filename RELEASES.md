...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `0.1.0-rc.2` | Prerelease | `v0.1.0-rc.2` | Pending tag commit | `ai-quant-strategy-workflow-0.1.0-rc.2.zip` | `9b35b08de88936312b0153b7bfcee091f94483609156238ba3b8867edde5f50c` | Pending public-URL run | Static compatibility only |
