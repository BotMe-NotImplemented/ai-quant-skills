...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `1.0.0` | Stable | `v1.0.0` | `3b904b778720e4547547b446f6569bd0d9349542` | `ai-quant-strategy-workflow-1.0.0.zip` | `db4ca0438f6c64268f4f6f82585cb846a818f37f9153670ce918ffac0807ecd5` | Public tag install + discovery + 6/6 behavior PASS | Static compatibility only |
